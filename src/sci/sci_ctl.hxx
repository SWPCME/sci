 ...
 * Purpose:  Sci controler definition.
...
#ifndef SCI_CTL_HXX_INCLUDED
#define SCI_CTL_HXX_INCLUDED
...
namespace sci
{
    ...
    class SCI_LIB CSciCtl
    {
      ...
      private:
        static CSciCtl *mSci;
        CSciModuleCtl *mModule;
    };
}

#endif  // SCI_CTL_HXX_INCLUDED
